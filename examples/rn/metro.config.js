// monorepo 支撑：@yophon/tau-* 经 file: 符号链接指向 ../../packages，且是纯 TS 源码包
...
config.resolver.extraNodeModules = {
	"@yophon/tau-kernel": path.resolve(root, "packages/kernel"),
	"@yophon/tau-host-rn": path.resolve(root, "packages/host-rn"),
};
