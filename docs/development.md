...
- pi 快照位于本仓库同级目录 `../pi`（绝对路径 `/Users/[user]/Desktop/yophon/pi`），**版本 v0.80.3，非 git 仓库**。快照若丢失，用 `git clone --depth 1 --branch v0.80.3 https://github.com/earendil-works/pi-mono ../pi && rm -rf ../pi/.git` 重建（2026-07-14 曾因仓库搬家丢失过一次，按此重建）
